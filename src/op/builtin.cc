...
TVM_REGISTER_PASS_CONFIG_OPTION(kLayoutDagVisualizationEnable, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kLayoutDagVisualizationFormats, String);
TVM_REGISTER_PASS_CONFIG_OPTION(kLayoutDagVisualizationOutputDir, String);
